...
class UniversitySeeder extends Seeder
{
    ...
    public function run(): void
    {
        $universities = [
            ...
            [
                'state' => 'La Unión',
                'name' => 'Universidad de El Salvador (UES) - Campus La Unión',
            ],

            [
                'state' => 'Morazán',
                'name' => 'Universidad de El Salvador (UES) - Campus San Francisco Gotera',
            ],
            ...
            [
                'state' => 'San Vicente',
                'name' => 'Universidad de El Salvador (UES) - Campus San Vicente',
            ],
            ...
            [
                'state' => 'Usulután',
                'name' => 'Universidad de El Salvador (UES) - Campus Usulután',
            ],
