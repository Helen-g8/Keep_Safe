<x-layout>
    ...
    <div class="w-full flex justify-center">
        <button id="openModalBtn" class="px-8 mt-6 mb-6 bg-purple-800 text-white p-2 rounded hover:bg-purple-600">Filters</button>
    </div>
    ...
    <div id="modal" class="fixed inset-0 bg-gray-900 bg-opacity-50 flex items-center justify-center z-50 hidden">
        <div class="bg-white rounded-lg shadow-lg w-11/12 md:w-8/12 lg:w-6/12 xl:w-5/12 h-4/5 p-6 relative overflow-auto">
            ...
            <form id="filtersForm" class="flex flex-col space-y-6" method="get" action="/mostrarArrendamientos_filtros">
                <div class="space-y-4">
                ...
                <button type="button" id="viewLeasesBtn" class="mt-4 bg-purple-800 text-white p-2 rounded hover:bg-purple-600">View leases</button>
            </form>
        </div>
    </div>

    <script>
        document.getElementById('viewLeasesBtn').addEventListener('click', function() {
